...
<section id="getintouch" >
    <div class="container" style="border-bottom: 0;">
        <h1>
            <span>软件定义网络信息与防御后台管理-修改交换机信息</span>
        </h1>
    </div>

    <div class="container">
        <form class="contact" action="${pageContext.request.contextPath}/modifySwitch" method="post" id="form">
            <input type="hidden" id="id" name="id" value="${switch_.id}">
            <div class="row clearfix">
                ...
                <div class="ctrl">
                    <input type="text" id="mac" name="mac" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.mac}" required>
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" id="version" name="version" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.version}">
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" id="ipv4" name="ipv4" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.ipv4}" required>
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" id="ipv6" name="ipv6" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.ipv6}" required>
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" id="ports" name="ports" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.ports}" required>
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" id="flows" name="flows" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.flows}" required>
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" id="role" name="role" data-required="true" data-validation="text"
                           data-msg="Invalid Name" placeholder="${switch_.role}" required>
                </div>
            </div>
            <div class="row  clearfix">
