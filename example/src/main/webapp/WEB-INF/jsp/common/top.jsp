    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="${pageContext.request.contextPath}/toMain">SDN管理与防御系统</a>
            </div>

            <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="#">系统介绍<span class="sr-only">(current)</span>  </a>
                    </li>
                    <li><a href="#">网络信息管理</a></li>
                    <li><a href="#">网络防御</a></li>
                    <li><a href="sflowlist">流表查询</a></li>
                    <li><a href="/toAdmin">管理员信息</a></li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-pills nav-stacked">
                            ...
                            <li><a href="${pageContext.request.contextPath}/loginOut" class="hrms_logout"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> 账号退出</a></li>
                        </ul>
                    </li>
