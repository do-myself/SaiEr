    ...
    <div class="table_items">
        <ul class="pull-left">
            ...
            <c:if test="${param.currentPageNo > 1}">
                <a href="${pageContext.request.contextPath}/switchList?pageNo=1">首页</a>
                <a href="${pageContext.request.contextPath}/switchList?pageNo=${param.currentPageNo-1}">上一页</a>
            </c:if>
            <c:if test="${param.currentPageNo < param.totalPageCount }">
                <a href="${pageContext.request.contextPath}/switchList?pageNo=${param.currentPageNo+1}">下一页</a>
                <a href="${pageContext.request.contextPath}/switchList?pageNo=${param.totalPageCount}">最后一页</a>
            </c:if>
            &nbsp;&nbsp;
        </ul>
        <br>
        <form action="${pageContext.request.contextPath}/switchList">
